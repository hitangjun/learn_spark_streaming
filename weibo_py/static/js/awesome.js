...
function formatDate(date,format){
    ...
    var cfg = {
        ...
        ,hh : (""+date.getHours()).length ==1 ? "0"+date.getHours() : date.getHours()  //时
        ,mm : (""+date.getMinutes()).length ==1  ? "0"+date.getMinutes() : date.getMinutes() //分
        ,ss : (""+date.getSeconds()).length ==1  ? "0"+date.getSeconds() : date.getSeconds() //秒
    }
